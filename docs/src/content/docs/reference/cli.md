...
| `1` | amber | Not caught up yet, needs a one-time bootstrap, has a peer byte-path that does not currently resolve, or evidence aged past policy. Recoverable and expected. |
