...
--
-- Flattened snapshot of the squirrel index schema at version 22, for humans
...
CREATE TABLE destination_run_ids (
			...
			origin_node_id INTEGER NOT NULL REFERENCES nodes(id),
			origin_run_id  INTEGER NOT NULL,
			updated_at_ns  INTEGER NOT NULL, verify_method TEXT, source_node_id INTEGER REFERENCES nodes(id),
			PRIMARY KEY (volume_id, destination, origin_node_id)
		);
