...
--
-- Flattened snapshot of the squirrel index schema at version 30, for humans
...
CREATE TABLE config_drift (
	...
	, pending_keys TEXT NOT NULL DEFAULT '', apply_error TEXT NOT NULL DEFAULT '') STRICT;
...
CREATE TABLE destination_alarms (
...
CREATE TABLE "runs" (
	...
	shallow           INTEGER CHECK (shallow IS NULL OR shallow IN (0, 1)), changed_count INTEGER CHECK (changed_count IS NULL OR changed_count >= 0),
	CHECK (
